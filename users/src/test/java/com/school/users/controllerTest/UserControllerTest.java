...
public class UserControllerTest {
    ...
    public void testUpdateUserNullId() throws Exception {
        ...
        mockMvc.perform(mockRequest)
                ...
                .andExpect(result -> assertTrue(result.getResolvedException() instanceof UserController.InvalidRequestException))
                .andExpect(result ->
                        assertEquals("Username, password or ID must not be null!", result.getResolvedException().getMessage()));
    }
}
